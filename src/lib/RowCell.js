...
class RowCell extends Component {
  ...
  render() {
    ...
    if (showExpandCollapse && !isExpanded) {
      expandToggleIcon =
        <button className="icon-expand" aria-expand="false" onClick={onExpandToggle}>
      ...
      expandToggleIcon =
        <button className="icon-collasped" aria-expand="true" onClick={onExpandToggle}>
    ...
    return (
      <td className='tgrid-data-cell' role="gridcell">
        ...
        {colField == "grade" ?
          <span>
            {rowData.grade ? <button className="icon-View">
